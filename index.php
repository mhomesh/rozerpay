...
<input type="hidden" name="surl" id="surl" value="http://localhost/projects/rozorpay/success.php"> 
<input type="hidden" name="furl" id="furl" value="http://localhost/projects/rozorpay/failed.php"> 
